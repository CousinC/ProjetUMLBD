...
import projetumlbd.Catalogue;
import projetumlbd.I_Catalogue;
import projetumlbd.I_Produit;
import projetumlbd.Produit;
...
public class CatalogueTest {
	...
	public void setUp() {
		cat = new Catalogue();
//		Si votre Catalogue est un Singleton, il faut changer la ligne précédente puis vider le Catalogue avec la mêthode clear() comme indiqué é la ligne suivante
//		cat.clear();
	}
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomEspacesALaFin() {
		...
		cat.addProduit(p1);
		I_Produit p2 = createProduit("Mars ", 15, 2);
		assertFalse("ajout deux produits avec même nom mais un avec des espaces é la fin", cat.addProduit(p2));
	}
	...
	public void testAddProduitIProduit_deuxFoisProduitMemeNomTabulationsALaFin() {
		...
		cat.addProduit(p1);
		I_Produit p2 = createProduit("Mars	", 15, 2);
		assertFalse("ajout deux produits avec même nom mais un avec des tabulations é la fin", cat.addProduit(p2));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisProduitMemeNomEspacesALaFin() {
		I_Produit p1 = createProduit("Mars", 10, 1);
		cat.addProduit(p1);
		assertFalse("ajout deux fois même produit mais un avec espaces é la fin", cat.addProduit("Mars ", 10, 1));
	}
	...
	public void testAddProduitStringDoubleInt_deuxFoisProduitMemeNomTabulationsALaFin() {
		I_Produit p1 = createProduit("Mars", 10, 1);
		cat.addProduit(p1);
		assertFalse("ajout deux fois même produit mais un avec tabulations é la fin", cat.addProduit("Mars	", 10, 1));
	}
	...
	public void testAddProduits_produitsAvecUnSeulDoublon() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec un seul des produits déjé dans le catalogue",3, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecCertainsDoublons() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec plusieurs produits déjé dans le catalogue",2, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecQueDesDoublons() {
		...
		liste.add(p1);
		liste.add(p2);
		assertEquals("ajout liste avec tous les produits déjé dans le catalogue",0, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecDoublonsNomProduitsEspacesALaFin() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec produit espace é la fin du nom",3, cat.addProduits(liste));
	}
	...
	public void testAddProduits_produitsAvecDoublonsNomProduitsTabulationsALaFin() {
		...
		liste.add(p2);
		liste.add(p4);
		assertEquals("ajout liste avec produit tabulation é la fin du nom",3, cat.addProduits(liste));
	}
	...
	public void testGetNomProduits_vide() {
		...
		assertArrayEquals("recupére nom produits catalogue vide", tab0, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduit() {
		String[] tab = {"Mars"};
		cat.addProduit("Mars", 10, 1);
		assertArrayEquals("recupére nom produits avec un seul produit", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesAuDebut() {
		String[] tab = {"Mars"};
		cat.addProduit(" Mars", 10, 1);
		assertArrayEquals("recupére nom produit avec espace debut ; les espaces au début ne doivent pas étre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesALaFin() {
		String[] tab = {"Mars"};
		cat.addProduit("Mars ", 10, 1);
		assertArrayEquals("recupére nom produit avec espace fin ; les espaces é la fin ne doivent pas étre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomEspacesAuMilieu() {
		...
		assertArrayEquals("recupére nom produit avec des espace au milieu", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuDebut() {
		String[] tab = {"Mars"};
		cat.addProduit("	Mars", 10, 1);
		assertArrayEquals("recupére nom produit avec tabulation debut ; les tabulations au début ne doivent pas étre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsALaFin() {
		String[] tab = {"Mars"};
		cat.addProduit("Mars	", 10, 1);
		assertArrayEquals("recupére nom produit avec tabulation fin ; les tabulations é la fin ne doivent pas étre stockés", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_unProduitAvecNomTabulationsAuMilieu() {
		String[] tab = {"Kit Kat"};
		cat.addProduit("Kit	Kat", 10, 1);
		assertArrayEquals("recupére nom produit avec des tabulations au milieu ; les tabulations au milieu doivent étre remplacées par des espaces", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_deuxProduits() {
		...
		cat.addProduit("Mars", 10, 1);
		cat.addProduit("Treets", 10, 1);
		assertArrayEquals("recupére nom de deux produits", tab, cat.getNomProduits());
	}
	...
	public void testGetNomProduits_plusieursProduitsInseresOrdreAlphabetique() {
		...
		cat.addProduit("Raider", 12, 2);
		cat.addProduit("Treets", 10, 1);
		assertArrayEquals("recupére nom de plusieurs produits ajoutés dans ordre alphabétique", tab, cat.getNomProduits());
	}	
	...
	public void testGetNomProduits_plusieursProduitsInseresOrdreAleatoire() {
		...
		assertArrayEquals("recupére nom de plusieurs produits ajoutés dans ordre aléatoire (doivent étre retournés dans l'ordre alphabétique)", tab, cat.getNomProduits());
	}
	...
	public void testMontantTotalTTC_avecVirgule_AvecArrondiInferieur_TroisChiffresApresLaVirgule() {
		...
		assertEquals("montant TTC avec virgule ; 135.192 doit étre arrondi é 135.19",135.19,cat.getMontantTotalTTC(),0);
	}
	...
	public void testMontantTotalTTC_avecVirgule_AvecArrondiSuperieur_TroisChiffresApresLaVirgule() {
		...
		assertEquals("montant TTC avec virgule ; 135.228 doit étre arrondi é 135.23",135.23,cat.getMontantTotalTTC(),0);
	}
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecUnChiffreApresVirgule() {
		...
		assertEquals("toString catalogue avec un total d'un chiffre aprés la virgule", resultatAttendu, cat.toString());
	}
	...
	public void testToString_CatalogueAvecDesProduits_TotalAvecDeuxChiffresApresVirgule() {
		...
		assertEquals("toString catalogue avec un total de deux chiffres aprés virgule", resultatAttendu, cat.toString());
	}
	...
	public void testClear() {
            ...
            cat.addProduit("Twix", 10.47, 2);
            cat.clear();
            assertTrue("", cat.getLesProduits().isEmpty());
	}
